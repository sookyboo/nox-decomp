...
int __cdecl sub_40F830(intptr_t a1);
...
int __cdecl sub_412100(int a1, char *a2, uintptr_t a3);
int __cdecl sub_4121B0(int a1, char *a2, uintptr_t a3);
int __cdecl sub_412260(int a1, char *a2, uintptr_t a3);
char *__cdecl sub_412310(int a1, char *a2, uintptr_t a3);
BOOL __cdecl sub_412360(int a1, char *a2, uintptr_t a3);
int __cdecl sub_412380(const char *a1, char *a2, _DWORD *a3);
int __cdecl sub_412490(const char *a1, char *a2, uintptr_t a3);
int __cdecl sub_412580(const char *a1, char *a2, uintptr_t a3);
int __cdecl sub_412670(const char *a1, char *a2, uintptr_t a3);
int __cdecl sub_412740(int a1, char *a2, uintptr_t a3);
int __cdecl sub_412760(char *a1, int *a2);
int __cdecl sub_4128A0(int a1, char *a2, uintptr_t a3);
int __cdecl sub_4128C0(int a1, char *a2, uintptr_t a3);
int __cdecl sub_412930(char *a1, char *a2);
int __cdecl sub_412AE0(const char *a1, FILE *a2, char *a3);
int __cdecl sub_412C60(const char *a1, uintptr_t a2);
...
void __cdecl sub_421040(uintptr_t a1);
char *sub_4210A0();
char *__cdecl sub_4210E0(uintptr_t a1);
int sub_421130();
int __cdecl sub_421160(uintptr_t a1);
int __cdecl sub_4211D0(uintptr_t a1);
...
int __cdecl sub_421880(int2 *a1, uintptr_t a2, float a3); // idb
...
int __cdecl sub_4235C0(const char *a1, uintptr_t a2, uintptr_t a3);
int __cdecl sub_4235F0(const char *, float, uintptr_t); // idb
double sub_423730();
int __cdecl sub_423780(const char *a1, uintptr_t a2, _DWORD *a3);
...
int __cdecl sub_427DF0(int2 *a1, int *a2, float a3); // idb
...
void sub_43D2C0();
void sub_43D2D0();
void __cdecl sub_43D3C0(uintptr_t a1, int a2);
int sub_43D440();
int sub_43D650();
int sub_43D680();
int sub_43D6A0();
...
int sub_43E8E0();
int sub_43E910();
int __cdecl sub_43E940(uintptr_t a1);
int __cdecl sub_43E9C0(); // idb
_DWORD *__stdcall sub_43E9D0(int a1);
void sub_43E9F0();
int __cdecl sub_43EA20(uintptr_t a1);
int __cdecl sub_43EA90(uintptr_t a1, uintptr_t a2);
uintptr_t __cdecl sub_43EAD0(uintptr_t a1);
int sub_43EC10();
int __cdecl sub_43EC30(uintptr_t a1);
int __cdecl sub_43ECB0(uintptr_t a1);
...
int __cdecl sub_451DC0(uintptr_t a1);
int __cdecl sub_451E80(int a1);
int __cdecl sub_451F30(uintptr_t a1, int a2);
int __cdecl sub_451F90(uintptr_t a1);
...
int __cdecl sub_452410(uintptr_t a1);
...
int __cdecl sub_452EE0(uintptr_t a1, int a2);
unsigned int __cdecl sub_452F10(uintptr_t a1, int a2);
int __cdecl sub_452F50(int a1, int a2);
_DWORD *__cdecl sub_452F80(uintptr_t a1, int a2);
...
_DWORD *__cdecl sub_45DC40(uintptr_t a1, int a2, int a3);
int __cdecl sub_45DCA0(int a1, char a2, int a3, int a4, int *a5);
int __cdecl sub_45DDF0(uintptr_t a1);
int __cdecl sub_45DE10(int a1, uintptr_t a2);
...
wchar_t *__cdecl sub_45F300(uintptr_t a1, int a2, int a3);
...
int sub_460000();
int sub_460070();
int __cdecl sub_4601F0(uintptr_t a1, int a2, int a3, int a4, int a5, int a6, int a7);
void *sub_4602F0();
void *sub_460380();
_DWORD *sub_4603A0();
_DWORD *sub_4603F0();
...
int __cdecl sub_460A10(uintptr_t a1, int a2, int a3, char a4);
...
int sub_461450();
int __cdecl sub_461460(uintptr_t a1);
char *sub_461520();
...
int __cdecl sub_46AEE0(int a1, uintptr_t a2);
uintptr_t __cdecl sub_46AF00(int a1);
uintptr_t __cdecl sub_46AF40(int a1);
...
uintptr_t __cdecl sub_46B490(int a1, int a2, uintptr_t a3, int a4);
...
_DWORD *__cdecl sub_488500(int a1, int a2, int a3, int a4, int a5, int a6, uintptr_t a7, wchar_t *a8);
uintptr_t __cdecl sub_488710(int a1, unsigned int a2, wchar_t *a3, int a4);
...
int __cdecl sub_48EA70(int a1, uintptr_t a2, int a3);
...
int __cdecl sub_4A10A0(uintptr_t *a1, const char *a2, char *a3);
...
void __cdecl sub_4A3C00(uintptr_t a1, uintptr_t a2);
int __cdecl sub_4A3C50(_DWORD *a1, int a2);
int __cdecl sub_4A3FC0(_DWORD *a1, int a2);
_DWORD *__cdecl sub_4A4310(int a1, int a2, int a3, int a4, int a5, int a6, uintptr_t a7, __int16 *a8);
...
int sub_4A50D0();
int sub_4A5150();
void *nox_profile_list_alloc(size_t count);
void nox_profile_list_free(void *address);
...
int __cdecl sub_4A9330(int a1, int a2, int a3, int a4, int a5, int a6, uintptr_t a7, _DWORD *a8);
...
int __cdecl sub_4B5640(int a1, int a2, uintptr_t a3);
...
int sub_4C03E0();
int __cdecl sub_4C0430(uintptr_t a1, int a2, int a3, int a4, int a5, const void *a6, int a7, int a8, int a9, int a10);
...
void sub_4C9970();
void sub_4C9B20();
int __cdecl sub_4C9BF0(uintptr_t a1);
...
void sub_4DD310();
_DWORD *__cdecl sub_4DD320(int a1, uintptr_t a2);
int __cdecl sub_4DD9B0(char a1, const void *a2, int a3);
char *__cdecl sub_4DDA00(uintptr_t a1);
unsigned int __cdecl sub_4DDA90(uintptr_t a1, uintptr_t a2);
_DWORD *__cdecl sub_4DDB40(_DWORD *a1);
FILE *__cdecl sub_4DDDC0(int a1);
_DWORD *__cdecl sub_4DDE10(int a1, uintptr_t a2);
...
uintptr_t nox_game3_thing_player_info(uintptr_t thing);
...
int __cdecl sub_4E5390(int a1, uintptr_t a2, int a3, int a4, int a5);
...
int __cdecl sub_4E60E0(uintptr_t a1);
int __cdecl sub_4E6150(uintptr_t a1);
int sub_4E6230();
int __cdecl sub_4E6280(uintptr_t a1);
...
int __cdecl sub_4EFC80(uintptr_t a1);
int __cdecl sub_4EFD80(uintptr_t a1);
char __cdecl sub_4EFE10(uintptr_t a1);
...
int __cdecl sub_4F5580(uintptr_t a1, char *a2);
...
int __cdecl sub_500F40(intptr_t a1, void *out_xy);
...
int __cdecl sub_50A5C0(void *p);
void __cdecl sub_5281F0(void *self);
...
int __cdecl sub_5175E0(float, uintptr_t); // idb
