...
| `0081aa0` | Makes rendering/cursor handling safe for ARM native-resolution surfaces. | Headless SDL surface test creates a non-640x480 surface, runs stretch/viewport and cursor-color conversion, and checks dimensions/pixel values on ARMHF and i386. |
