- Extended Reloaded/Panic EUD compatibility for Monster-style unit customization, voice/bin-script pointers, health/gold/wand backing data, fixed green FX/LinearOrbMove helpers, and exact projectile/pickup handlers without executing generated x86
